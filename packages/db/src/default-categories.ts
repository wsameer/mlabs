...
export const DEFAULT_CATEGORY_TREE: CategoryDef[] = [
  // ── Income (flat) ──
  { name: "Salary",        type: "INCOME", icon: "💼", color: "#10b981", sortOrder: 1 },
  { name: "Bonus",         type: "INCOME", icon: "🎯", color: "#22c55e", sortOrder: 2 },
  { name: "Cashback",      type: "INCOME", icon: "💳", color: "#14b8a6", sortOrder: 3 },
  { name: "Refund",        type: "INCOME", icon: "↩️", color: "#0ea5e9", sortOrder: 4 },
  { name: "Bank Interest", type: "INCOME", icon: "🏦", color: "#3b82f6", sortOrder: 5 },
  { name: "Dividends",     type: "INCOME", icon: "📈", color: "#8b5cf6", sortOrder: 6 },
  { name: "CRA Benefits",  type: "INCOME", icon: "🍁", color: "#ef4444", sortOrder: 7 },
  { name: "Rental Income", type: "INCOME", icon: "🏘️", color: "#f59e0b", sortOrder: 8 },
  { name: "Freelance",     type: "INCOME", icon: "💻", color: "#6366f1", sortOrder: 9 },
  { name: "Gift",          type: "INCOME", icon: "🎁", color: "#ec4899", sortOrder: 10 },
  { name: "Other Income",  type: "INCOME", icon: "💰", color: "#64748b", sortOrder: 11 },

  // ── Expense (with sub-categories) ──
  {
    name: "Housing", type: "EXPENSE", icon: "🏠", color: "#ef4444", sortOrder: 1,
    children: [
  ...
  {
    name: "Transportation", type: "EXPENSE", icon: "🚗", color: "#f97316", sortOrder: 2,
    children: [
  ...
  {
    name: "Utilities", type: "EXPENSE", icon: "⚡", color: "#06b6d4", sortOrder: 3,
    children: [
  ...
  {
    name: "Food & Dining", type: "EXPENSE", icon: "🍽️", color: "#84cc16", sortOrder: 4,
    children: [
  ...
  {
    name: "Healthcare", type: "EXPENSE", icon: "🏥", color: "#ef4444", sortOrder: 5,
    children: [
  ...
  {
    name: "Entertainment", type: "EXPENSE", icon: "🎬", color: "#ec4899", sortOrder: 6,
    children: [
  ...
  {
    name: "Shopping", type: "EXPENSE", icon: "🛍️", color: "#a855f7", sortOrder: 7,
    children: [
  ...
  { name: "Groceries",         type: "EXPENSE", icon: "🛒", color: "#22c55e", sortOrder: 8 },
  { name: "Subscriptions",     type: "EXPENSE", icon: "🔁", color: "#3b82f6", sortOrder: 9 },
  { name: "Personal Care",     type: "EXPENSE", icon: "💆", color: "#8b5cf6", sortOrder: 10 },
  { name: "Gifts & Donations", type: "EXPENSE", icon: "🎀", color: "#f43f5e", sortOrder: 11 },
  { name: "Education",         type: "EXPENSE", icon: "🎓", color: "#0ea5e9", sortOrder: 12 },
  { name: "Other Expense",     type: "EXPENSE", icon: "📦", color: "#64748b", sortOrder: 13 },
];
...
export async function seedCategoriesForProfile(
  ...
  const insertedParents = await d.insert(categories).values(parentRows).returning();
  ...
  const insertedChildren = await d.insert(categories).values(childRows).returning();
